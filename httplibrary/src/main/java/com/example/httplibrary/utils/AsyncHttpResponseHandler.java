...
public abstract class AsyncHttpResponseHandler implements ResponseHandlerInterface {
    ...
    private EventRunner looper = null;
     ...
     */
    public AsyncHttpResponseHandler(EventRunner looper) {
        // Do not use the pool's thread to fire callbacks by default.
        this(looper == null ? EventRunner.create(true) : looper, false);
    }
    ...
    public AsyncHttpResponseHandler(boolean usePoolThread) {
        this(usePoolThread ? null : EventRunner.create(true), usePoolThread);
    }



    public AsyncHttpResponseHandler(EventRunner looper, boolean usePoolThread) {
        if (!usePoolThread) {
